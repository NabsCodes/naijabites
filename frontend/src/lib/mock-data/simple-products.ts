// Simplified Product Interface for Frontend Testing
...
export const getFeaturedProducts = () => simpleProducts;

// Helper function to get products by category
export const getProductsByCategory = (category: string) =>
  simpleProducts.filter((product) => product.category === category);

// Helper function to get product by slug
export const getProductBySlug = (slug: string) =>
  simpleProducts.find((product) => product.slug === slug);
