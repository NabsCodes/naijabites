  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6">
          ...
          <CardContent>
            <div className="mb-4 flex items-center justify-between">
              ...
              <Button
                ...
                className="h-7 px-3 text-xs font-medium text-green-dark hover:bg-green-dark/10 hover:text-green-dark"
              >
                {showAllPasswords ? (
                  <>
        ...
        {/* Account Actions */}
        <Card className="border-red-200 bg-red-50/30 transition-all duration-200 hover:shadow-sm">
          <CardHeader>
