  ...
  return (
    <div className="space-y-6">
      ...
      {addresses.length > 0 ? (
        ...
        /* Empty State */
        <Card className="border-2 border-dashed shadow-none transition-all duration-300 hover:shadow">
          <CardContent className="py-16 text-center">
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full border border-green-deep/10 bg-green-dark/10">
              <MapPinIcon className="h-8 w-8 text-green-dark" />
            </div>
            ...
            <Button
              onClick={handleAddNewAddress}
              variant="outline"
              className="border-green-dark text-green-dark transition-all duration-300 hover:bg-green-dark/5 hover:text-green-dark"
            >
              <PlusIcon className="mr-2 h-4 w-4" />
