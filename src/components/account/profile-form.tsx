...
export function ProfileForm() {
  ...
  const handleImageUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      // Change this for production to upload the file and get a URL back
      toast({
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <div className="mt-2 flex items-center gap-2">
                <Badge
                  variant="secondary"
                  className="bg-green-dark/10 text-green-dark hover:bg-green-dark/5"
                >
                    ...
                    <FormItem className="flex items-center justify-between space-y-0">
                      <div className="space-y-0.5">
                        <div className="flex items-center gap-2">
                          ...
                          <Badge
                            variant="outline"
                            className="bg-green-dark/10 text-xs text-green-dark hover:bg-green-dark/5"
                          >
                            Recommended
                          </Badge>
                        </div>
