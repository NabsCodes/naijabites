    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="mb-2 flex items-start justify-between">
          <div className="min-w-0 flex-1">
            <Link href={`/shop/products/${item.product.slug}`}>
              <h3 className="line-clamp-2 text-sm font-semibold text-gray-900 transition-colors hover:text-green-dark sm:text-base">
                {item.product.name}
              </h3>
            </Link>
            ...
            {item.variant && (
              <div className="mt-1 inline-flex items-center gap-1 rounded-md border border-green-200 bg-green-50 px-2 py-1">
